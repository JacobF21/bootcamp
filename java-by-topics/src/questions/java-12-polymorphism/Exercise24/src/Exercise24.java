...
public class Exercise24 {
    ...
    public void doSomething(String string) {
        System.out.println("do " + string);
    }
    public void doSomething(int num) {
        System.out.println("do something "+num+" times");
    }
    public void doSomething(String string,int num) {
        System.out.println("do "+string+" "+num+ " times");
    }
